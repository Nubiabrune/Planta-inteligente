...
const char* password = "henumafest"; //senha da rede WiFi
...
String topicoPrefixo = "MACK20009161"; //para o prefixo do topico, utilizar MACK seguido do TIA
...
bool irrigar = false;
void setup() {
  pinMode(rele, INPUT); //pino zero, onde esta ligado o pushbutton
  pinMode(sensor, OUTPUT); //pino 1, onde esta ligado o LED
